...
const MobileHome = () => {
  ...
  // delete selected images and update state
  const handleDelete = () => {
      ...
      <div className="wrapper bg-gray-50 w-full">
        <div className="grid-container bg-white p-5 rounded-md">
          <div className="flex justify-between items-center">
            ...
            {countSelected > 0 && (
              <button
                ...
                className="text-red-500 hover:underline rounded-md"
              >
                Delete Files
              </button>
            )}
          ...
          <div className="grid lg:grid-cols-5 md:grid-cols-3 grid-cols-2 gap-4 py-4">
            ...
            <label
              htmlFor="file"
              className="md:col-span-1 col-span-2 row-span-1 border rounded-md cursor-pointer min-h-[175px]"
            >
